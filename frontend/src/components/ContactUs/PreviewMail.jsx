...
// const PreviewMail = ({ value, sendEmail }) => {
...
//     const { to, from, password, subject, message } = value;
//     if (
...
//       console.log("Loading before send:", loading);

//       await sendEmail(bannerData);
      
//       console.log("Loading after send:", loading);
//     } catch (error) {
//       Swal.fire({
//         title: "Error",
...
//       setTimeout(() => {
//         setLoading(false); // Reset loading state after 6 seconds
//       }, 6000)
//     }
//   };
...
//                 <div>
//                   <p>Delivered Mail :</p>
//                   <p>Undelivered Mail : </p>
//                 </div>
//                 <LinearWithValueLabel/>
//                 <div className="d-flex justify-content-center preview_btn">
//                   <CLoadingButton
//                     color="primary"
//                     loading={loading} // Show loader only when loading is true
//                     type="submit"
